 ...
 */
@Controller
public class ManagementSolrController {
    ...
    */
    ...
    @Autowired
    public ManagementSolrController(CourseService courseService, ConversionService conversionService) {
        this.courseService = courseService;
        this.conversionService = conversionService;
    }

    @RequestMapping(value = "/manage/updatesolr")
