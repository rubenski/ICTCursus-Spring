    ...
    <c:otherwise>
        <form:form modelAttribute="accountActivationFormData">
            ...
            <div class="default-block">
                ...
                <input cssClass="form-input" cssErrorClass="form-input-error" size="50" maxlength="60" disabled="true"
            ...
            <div class="default-block">
                ...
                <form:password path="password1" cssClass="form-input" cssErrorClass="form-input-error" size="50" maxlength="60"/>
            ...
            <div class="default-block">
                ...
                <form:password path="password2" cssClass="form-input" cssErrorClass="form-input-error" size="50" maxlength="60"/>
