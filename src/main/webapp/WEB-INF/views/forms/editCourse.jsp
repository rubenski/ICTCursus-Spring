    ...
    <div id="data-entry-form">
        ...
        <c:if test="${courseValid != ''}">
            ...
            <c:if test="${courseValid == 'true'}">
                <div id="validMessage" class="form-entry"><spring:message code="course.form.valid"/></div>
            </c:if>
            <c:if test="${courseValid == 'false'}">
                <div id="invalidMessage" class="form-entry"><spring:message code="course.form.invalid"/></div>
            </c:if>
