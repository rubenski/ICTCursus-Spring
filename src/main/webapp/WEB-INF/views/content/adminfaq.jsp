...
<div class="default-block">
    ...
    <h4>Voorbeeld zonder opties :</h4>
    <p>
        Stel u ontvangt een aanvraag voor een cursus die 575 euro per persoon kost, dan betaalt u voor deze aanvraag<br><br>

        575 (cursusprijs) * 0.01 (1.0 procent) = &#0128;5,75 excl. BTW.
    </p>

    <h4>Voorbeeld optie uitgebreide weergave in lijsten :</h4>
    <p>
        Stel u heeft <b>uitgebreide weergave in lijsten</b> geactiveerd en u ontvangt een aanvraag voor een cursus die 575 euro per persoon kost,
        dan betaalt u voor deze aanvraag <br><br>

        575 (cursusprijs) * 0.015 (1.5 procent) = &#0128;8,63 excl. BTW.
    </p>

    <h4>Voorbeeld opties uitgebreide weergave in lijsten én uitgebreide weergave bedrijfsgegevens :</h4>
    <p>
        Stel u heeft <b>uitgebreide weergave in lijsten</b> én <b>uitgebreide weergave bedrijfsgegevens</b> geactiveerd en u ontvangt een aanvraag voor een
        cursus die 575 euro per persoon kost, dan betaalt u voor deze aanvraag <br><br>

        575 (cursusprijs) * 0.02 (2.0 procent)= &#0128;11,50 excl. BTW.
    </p>
</div>
...
<div class="default-block">
    ...
    <p>De cursussen die u op ictcursus.nl plaatst verschijnen in zoekresultaten en op de categorie waar u de cursus in geplaatst heeft.
        ...
        De eenvoudige weergave is standaard geselecteerd. Voor deze weergave betaalt u niets extra. Voor de uitgebreide weergave betaalt u 0.5 procent extra per aanvraag die
        u via ictcursus.nl ontvangt. U betaalt dus altijd pas zodra u een aanvraag ontvangt.
    </p>

    <h4>Eenvoudige weergave</h4>
    <p>De eenvoudige weergave bevat de cursustitel en de korte omschrijving van de cursus.</p>
    <img src="/static/img/simple-course-item.png"/>
    <br/><br/>
    <h4>Uitgebreide weergave</h4>
    <p>De uitgebreide weergave springt meer in het oog en bevat een dikgedrukte titel, de korte omschrijving van de cursus, uw bedrijfslogo, uw bedrijfsnaam en een lijst met onderwerpen.</p>
    <img src="/static/img/advanced-course-item.png"/>
    <p>Bekijk hierboven de veelgestelde vraag 'Wat kost een aanvraag' voor meer inzicht in de kosten van een aanvraag.</p>
</div>
...
<div class="default-block">
    ...
    <h4>Eenvoudige weergave</h4>
    <p>De eenvoudige weergave van uw bedrijfsgegevens bestaat uit een vermelding van uw bedrijfsnaam naast de cursusbeschrijving.</p>
    <img src="/static/img/company-info-simple.png"/>
    <br/><br/>
    <h4>Uitgebreide weergave</h4>
    <p>De uitgebreide weergave springt meer in het oog en bevat uw adresgegevens, uw logo, een link naar uw persoonlijke bedrijfspagina en een lijst met andere relevante cursussen van uw bedrijf.</p>
    <img src="/static/img/company-info-advanced.png"/>
    <br/><br/>
